      ...
      <div class="col-12 col-sm-6">
        ...
        <form v-on:submit.prevent="addBrewery">
          ...
          <form v-on:submit.prevent="addcontact">
            ...
            <input type="email" class="form-control mb-1" placeholder="Mail" v-model="newcontact.mail" required>
            ...
            <template v-if="edit === false">
              <dir class="col-12"><button class="btn btn-success btn-block " >ADD BREWERY</button></dir>
            </template>
            <template v-else>
              <dir class="col-12"><button class="btn btn-success btn-block " >UPDATE BREWERY</button></dir>
            </template>
        </form>
      </div>
...
methods:{
  ...
  updateBrewery(idBrewery){
    ...
    .then(res =>{
      ...
      this.newBrewery = new newBrewery(res.data.brewery._id,res.data.brewery.name,res.data.brewery.contact)
